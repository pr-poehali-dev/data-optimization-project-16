...
const testimonials = [
  {
    quote:
      "Быстро и результативно! Искал логотип и лендинг под новый бизнес — CodeCraft сделали всё с первого раза, без лишних правок. Очень доволен.",
    name: "Патрик",
  ...
  {
    quote:
      "Работали с CodeCraft над интернет-магазином. Сдали в срок, сайт летает, поддержка отвечает быстро. Уже планируем следующий проект вместе.",
    name: "Анна",
